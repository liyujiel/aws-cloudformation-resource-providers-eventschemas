...
public class UpdateHandlerTest extends AbstractTestBase {
    ...
    public void handleRequest_SimpleSuccess() {
        ...
        UpdateRegistryResponse updateRegistryResponse = UpdateRegistryResponse.builder()
                .registryName("registry")
                .description("description")
                .build();

        DescribeRegistryResponse describeRegistryResponse = DescribeRegistryResponse.builder()
                .registryName("registry")
                .description("description")
                .build();

        doReturn(updateRegistryResponse, describeRegistryResponse)
                .when(proxy)
